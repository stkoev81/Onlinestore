...
/**
 * This class contains methods and fields relevant to account creation and
 * modification. It is a request scoped CDI managed bean. 
 * 
 */
...
public class AcctCreation {
    ...
    /**
     * Injected EJB for sending email
     */
    @EJB
    private MailSenderStateless mailSender;
    /**
     * Injected EJB for persistence operations. 
     */
    @EJB
     ...
     * cardNumber, carType, new Password because they need additional processing 
     * before being set in 
     * the user entity. 
     */
     ...
     * database
     * @param username
     * @return True if username available, false if already taken.
     */
    ...
    /**
     * Returns an array of years for the credit card expiration year. Includes
     * the current year and the next 20 years. 
     */
    public String[] years() {
    ...
    /**
     * Create a new account by setting various fields in the user
     * entity and then persisting it. Sends an activation email to the 
     * user once the account creation is completed.
     * @return Name of "Email Error" page if there is an EmailException; name of 
     * "Account creation success" page otherwise.
     */
    ...
    /**
     * Update an existing account by setting various fields in the 
     * UserEntity and then persisting it. 
     * @return Name of "Account changed" page
     */
     ...
     * name of the AccountActivation page, and a query string ( including
     * randomly generated activation string and username).
