...
public class ManageOrdersStateful {
    ...
    public void lookupOrder() throws MarkerException {
        // add lock
        order = em.find(OrderEntity.class, orderID, LockModeType.OPTIMISTIC);
    }

    public void updateOrderStatus(OrderStatusEntity ose) throws MarkerException {
    ...
    public void updateOrder(OrderStatusEntity ose) throws UpdateFailedException, MarkerException {
        ...
        try {
            ...
            // TODO: rollback succeeded
            if (e instanceof OptimisticLockException) {
                throw new UpdateFailedException();
                // TODO: mild error, will jsut display message to user;
            } else {
                throw new RuntimeException(e);
                // TODO: unknown error but at leasst rollback succeeded, log it. 
            }
        }
    ...
    public void cleanUpFailedOrders() throws MarkerException {
    ...
    public void updateWarehouseNumbers() throws MarkerException {
        for (OrderLineEntity ole : order.getOrderLines()) {
